...
// let nameCar = prompt("Digite o modelo do seu carro: ")
// let yearcar = prompt("Digite o ano do seu carro: ")

// let buyCar = prompt("Digite o valor que você pagou no seu carro: ")
// let parcelCar = prompt("Digite em quantas vezes você ira parcelar o valor do seu carro: ")

// for (let result; result = Math.round(buyCar).toFixed(3) / parcelCar; result++) {

//     function calcParcelCar(resultFinal = result) {

                
//         if (resultFinal = buyCar >= 20000.00) {

            
//             resultFinal = alert(`O valor do seu carro é de R$ ${Math.round(buyCar).toFixed(3)} e por você ter parcelado em ${parcelCar} vezes você ira pagar o valor de R$ ${result} por mes`)
            
//         } else {

//             resultFinal = alert(`O valor do seu carro é de R$  ${Math.round(buyCar).toFixed(3)} e por você ter parcelado em ${parcelCar} vezes você nao ira pagar o valor de R$ ${Math.round(result).toFixed(2)} por mes`)
